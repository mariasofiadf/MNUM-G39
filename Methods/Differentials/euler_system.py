...
def euler_qc(d_function1, d_function2, x0, y0, z0, xf, increment):
    error_0 = euler_system(d_function1, d_function2, x0, y0, z0, xf, increment)
    error_1 = euler_system(d_function1, d_function2, x0, y0, z0, xf, increment/2)
    error_2 = euler_system(d_function1, d_function2, x0, y0, z0, xf, increment/4)
    er = [0]*2
