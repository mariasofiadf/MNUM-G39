...
def rk4_qc(d_function1, d_function2, x0, y0, z0, xf, increment):
    error_0 = rk4_system(d_function1, d_function2, x0, y0, z0, xf, increment)[-1][1:]
    error_1 = rk4_system(d_function1, d_function2, x0, y0, z0, xf, increment/2)[-1][1:]
    error_2 = rk4_system(d_function1, d_function2, x0, y0, z0, xf, increment/4)[-1][1:]
    er = [0]*2
